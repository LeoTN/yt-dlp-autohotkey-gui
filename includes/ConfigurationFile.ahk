...
initializeConfigEntryMap() {
    ...
    ConfigFileEntry(MINIMIZE_APPLICATION_WHEN_VIDEO_LIST_GUI_IS_CLOSED,
        "MINIMIZE_APPLICATION_WHEN_VIDEO_LIST_GUI_IS_CLOSED",
        GeneralSettings, MINIMIZE_APPLICATION_WHEN_VIDEO_LIST_GUI_IS_CLOSED, "boolean")
    ...
    ConfigFileEntry(DEFAULT_DESIRED_SUBTITLES_ARRAY, "DEFAULT_DESIRED_SUBTITLES_ARRAY",
        VideoListDefaultPreferences, DEFAULT_DESIRED_SUBTITLES_ARRAY, "string")
    ConfigFileEntry(DEFAULT_DESIRED_SUBTITLES_EMBED_ALL, "DEFAULT_DESIRED_SUBTITLES_EMBED_ALL",
        VideoListDefaultPreferences, DEFAULT_DESIRED_SUBTITLES_EMBED_ALL, "boolean")
    ...
    ConfigFileEntry(CONFIRM_CHANGING_MULTIPLE_VIDEOS, "CONFIRM_CHANGING_MULTIPLE_VIDEOS",
        VideoListDefaultPreferences, CONFIRM_CHANGING_MULTIPLE_VIDEOS, "boolean")
...
importOldConfigFile(pOldConfigFileLocation, pBooleanAskForConfirmation := true, pBooleanReloadAfterImport := true) {
    ...
    if (importableConfigFileEntryMap.Count > 0 && pBooleanAskForConfirmation) {
        ...
        msgText .= "`n********************"
        msgText .= "`n`nYou need to restart VideoDownloader for the changes to take effect."
